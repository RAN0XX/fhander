exports.wait = () => {
	return`*「 WAIT 」 SEDANG DIPROSES! MOHON SABAR YA OM*`
}
...
exports.bug = () => {
	return`*Masalah telah di laporkan ke owner Hermansyahツ, Laporan palsu atau main² tidak akan ditanggapi.*`
}
...
exports.registered = (namaUser, umurUser, serialUser, time, sender) => {
	return`*「 DATABASE ${namabot} 」*\n\nkamu sudah terdaftar dengan data \n\n┏━⊱nama\n┗⊱${namaUser}\n┏━⊱nomer\n┗⊱wa.me/${sender.split("@")[0]}\n┏━⊱umur\n┗⊱${umurUser}\n┏━⊱waktu pendaftaran\n┗⊱${time}\n\n┏━❉ *NS* ❉━\n┣⊱${serialUser}\n┗⊱GRUP BOT :https://chat.whatsapp.com/Imr2vi3rsKJ8tbskw53edf
`
}
...
exports.limitend = (pushname) => {
	return`*Maaf ${pushname} limit hari ini habis*\n*Hubungi kami* : wa.me/6283818744065\n\n*Note : Kami akan berikan random dari 1-10*`
}
