...
//JANGAN LUPA SUBSCRIBE YT 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛
const {
   WAConnection,
   MessageType,
   Presence,
...
const vcard = 'BEGIN:VCARD\n' //jangan ganti Sayang
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6283818744065:+6283818744065\n'  //ganti nomor kamu sayang
...
namabot = '𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛' //ganti nama bot kamu
cr = '𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛' //ganti nama bot
faketoko = "𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛" //ganti nama bot
lolkey = 'e3d6805ea05cefd5b8fc3a9c' //apiknya ya sayang
zeksapi = 'Ardy-ApiKey' //free apikey
/******** OWNER NUMBER**********/

const ownerNumber = ["6283818744065@s.whatsapp.net"]   //ganti nomor kamu sayang
...
client.version = [2, 2119, 6]
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR code is ready, Scan now..','white'),color('Subrek Yt : Botz Dhani ?','red'),color('X','lime'),color('LolHuman','red'))
})
...
│◨ *ᴀꜱᴀʟ ᴋᴏᴛᴀ* :
│
│𝐒𝐄𝐌𝐎𝐆𝐀 𝐋𝐔𝐇 𝐁𝐄𝐓𝐀𝐇 𝐘𝐎 ${mdata.subject}
│
│𝐃𝐀𝐍 𝐉𝐀𝐍𝐆𝐀𝐍 𝐋𝐔𝐏𝐀 𝐁𝐀𝐂𝐀 𝐃𝐄𝐒𝐊𝐑𝐈𝐏𝐒𝐈 𝐘𝐎 😊
╰────────────────⊱`
				...
				try {
					...
					teks = `𝐍𝐀𝐇 𝐊𝐀𝐍 𝐀𝐃𝐀 𝐘𝐆 𝐊𝐄𝐋𝐔𝐀𝐑\n𝐊𝐄𝐊 𝐏𝐄𝐑𝐂𝐔𝐌𝐀 𝐌𝐀𝐒𝐔𝐊 𝐆𝐂
 @${num.split('@')[0]}\n❰ 𝐆𝐊 𝐔𝐒𝐀𝐇 𝐁𝐀𝐋𝐈𝐊 𝐋𝐀𝐆𝐈 𝐋𝐔𝐇 🗿 ❱`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	   ...
	   const from = mek.key.remoteJid
		...
		if (messageStubType == 'REVOKE') {
			...
			if (int.type == 'conversation' || int.type == 'extendedTextMessage') {
				const strConversation = `		 「 𝐀𝐍𝐓𝐈 𝐃𝐄𝐋𝐄𝐓𝐄 」
	...
	client.on('message-new', async (mek) => {
		...
		try {
			...
			const groupAdmins = isGroup ? getGroupAdmins(groupMembers) : ''
           	const ftoko = { key: { fromMe: false, participant: `6283818744065@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./src/logobot.jpg') }, "title": `Subrek ItsAra`, "productImageCount": 9999 }, "businessOwnerJid": `6283818744065@s.whatsapp.net`}}}
            ...
            if (bad.includes(messagesC)) {
                if (!isGroupAdmins) {
                    return reply("JAGA UCAPAN DONG!! 😠")
                        ...
                        .then(() => {
                            client.sendMessage(from, `*「 𝐀𝐍𝐓𝐈 𝐁𝐀𝐃𝐖𝐎𝐑𝐃 」*\nBotz Dhani akan kick kamu karena berkata kasar!`, text ,{quoted: mek})
                        }).catch(() => client.sendMessage(from, `Untung Botz Dhani bukan admin, kalo admin udah Botz kick!`, text , {quoted : mek}))
                } else {
...
client.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
		...
		case 'transfer':
				...
				if (!q.includes('|')) return  reply(ind.wrongf())
                		...
                		addKoinUser('6283818744065@s.whatsapp.net', fee)
...
case 'addbadword':
		...
		case 'giftlimit': 
				...
				const nomerr = args[0].replace('@','')
                		...
                		if (!nomerr) return reply(`maaf format salah\nmasukan parameter yang benar\ncontoh : ${prefix}giftlimit @6283818744065`)
...
╭─❲♛ 𝐈𝐍𝐅𝐎 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 ♛❳
│๖ۣ•҉ 𝐍𝐀𝐌𝐀 𝐁𝐎𝐓 :[${namabot}]
│๖ۣ•҉ 𝐍𝐀𝐌𝐀 𝐎𝐖𝐍𝐄𝐑 : Rendy 
│๖ۣ•҉ 𝐏𝐑𝐄𝐅𝐈𝐗 : 「 ${prefix}  」 
│๖ۣ•҉ 𝐒𝐄𝐑𝐕𝐄𝐑 : ${client.browserDescription[0]}
│๖ۣ•҉ 𝐕𝐄𝐑𝐒𝐈𝐎𝐍 : ${client.version[0]}
│๖ۣ•҉ 𝐘𝐎𝐔𝐓𝐔𝐁𝐄 : 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 ?
╰────────────────⊱
╭──>
╰────────────────⊱
╭──❲ 𝐈𝐍𝐅𝐎 𝐏𝐄𝐍𝐆𝐆𝐔𝐍𝐀 ❳
│๖ۣ•҉ 𝐍𝐀𝐌𝐀 : ${pushname}
│๖ۣ•҉ 𝐍𝐎𝐌𝐎𝐑 : wa.me/${sender.split("@")[0]}
│๖ۣ•҉ 𝐗𝐏 : ${getLevelingXp(sender)}
│๖ۣ•҉ 𝐑𝐀𝐍𝐊 : ${role}
│๖ۣ•҉ 𝐋𝐄𝐕𝐄𝐋 : ${getLevelingLevel(sender)}
╰────────────────⊱
╔┓┏╦━━╦┓╔┓╔━━╗
║┗┛║┗━╣┃║┃║┏┓║
║┏┓║┏━╣┗╣┗╣┗┛║
╚┛┗╩━━╩━╩━╩━━╝
╭──>  Subrek 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 // Di Ganti = Eror
╰────────────────⊱
...
│๖ۣ•҉${prefix}ara
│๖ۣ•҉${prefix}tolol
│๖ۣ•҉${prefix}sholawat
│๖ۣ•҉${prefix}pale
│๖ۣ•҉${prefix}wibu
│๖ۣ•҉${prefix}test
│๖ۣ•҉${prefix}tidurlah
│๖ۣ•҉${prefix}yamate
│๖ۣ•҉${prefix}baka
╰────────────────⊱

╭──❲ 𝐆𝐑𝐎𝐔𝐏 𝐌𝐄𝐍𝐔 ❳
│๖ۣ•҉${prefix}welcome [1/0]
│๖ۣ•҉${prefix}nsfw [1/0]
│๖ۣ•҉${prefix}antilink [1/0]
│๖ۣ•҉${prefix}leveling [1/0]
│๖ۣ•҉${prefix}nobadword [1/0]
│๖ۣ•҉${prefix}simih [1/0] 
│๖ۣ•҉${prefix}promote [@tag]
│๖ۣ•҉${prefix}demote [@tag]
│๖ۣ•҉${prefix}tagall
│๖ۣ•҉${prefix}listadmin
│๖ۣ•҉${prefix}wakillist
│๖ۣ•҉${prefix}premiumlist
│๖ۣ•҉${prefix}banlist
│๖ۣ•҉${prefix}blocklist
│๖ۣ•҉${prefix}linkgc
│๖ۣ•҉${prefix}mining
│๖ۣ•҉${prefix}hidetag
│๖ۣ•҉${prefix}grouplist
│๖ۣ•҉${prefix}add [62]
│๖ۣ•҉${prefix}kick [@tag]
│๖ۣ•҉${prefix}setname
│๖ۣ•҉${prefix}setdesc
│๖ۣ•҉${prefix}setpp
│๖ۣ•҉${prefix}listadmin
...
│๖ۣ•҉${prefix}mining
│๖ۣ•҉${prefix}level
│๖ۣ•҉${prefix}grup [buka/tutup]
│๖ۣ•҉${prefix}antidelete [aktif/mati]
│๖ۣ•҉${prefix}antidelete[ctaktif/ctmati]
│๖ۣ•҉${prefix}wame
│๖ۣ•҉${prefix}wa.me
╰────────────────⊱
...
╭──❲ 𝐎𝐖𝐍𝐄𝐑 𝐌𝐄𝐍𝐔 ❳
│๖ۣ•҉${prefix}bc
│๖ۣ•҉${prefix}nobadword
│๖ۣ•҉${prefix}addbadword
│๖ۣ•҉${prefix}delbadword
│๖ۣ•҉${prefix}bcgc
│๖ۣ•҉${prefix}kickall
│๖ۣ•҉${prefix}setreply
│๖ۣ•҉${prefix}setprefix
│๖ۣ•҉${prefix}clearall
│๖ۣ•҉${prefix}block
│๖ۣ•҉${prefix}unblock
│๖ۣ•҉${prefix}leave
│๖ۣ•҉${prefix}event [1/0]
│๖ۣ•҉${prefix}clone
│๖ۣ•҉${prefix}setppbot
│๖ۣ•҉${prefix}del
│๖ۣ•҉${prefix}ban [tag]
│๖ۣ•҉${prefix}unban 
│๖ۣ•҉${prefix}unbann [tag]
│๖ۣ•҉${prefix}setreplyy
│๖ۣ•҉${prefix}premium [tag]
│๖ۣ•҉${prefix}unpremium [tag] 
│๖ۣ•҉${prefix}admin
│๖ۣ•҉${prefix}unadmin
│๖ۣ•҉${prefix}setlimit
│๖ۣ•҉${prefix}setmemlimit 
╰────────────────⊱

╭──❲ 𝐄𝐗𝐏 𝐋𝐈𝐌𝐈𝐓 ❳
│๖ۣ•҉${prefix}dompet
│๖ۣ•҉${prefix}buypremiumlimit
│๖ۣ•҉${prefix}buylimit
│๖ۣ•҉${prefix}lb
│๖ۣ•҉${prefix}leaderboard
│๖ۣ•҉${prefix}limit
│๖ۣ•҉${prefix}transfer
│๖ۣ•҉${prefix}giftlimit
│๖ۣ•҉${prefix}kalkulator
│๖ۣ•҉${prefix}level
│๖ۣ•҉${prefix}profile
╰────────────────⊱
...
│๖ۣ•҉${prefix}loli
│๖ۣ•҉${prefix}elf
│๖ۣ•҉${prefix}emojitoimg
╰────────────────⊱

╭──❲ 𝐓𝐄𝐗𝐓 𝐏𝐑𝐎 𝐌𝐄 ❳
│๖ۣ•҉${prefix}blackpink text
│๖ۣ•҉${prefix}neon text
│๖ۣ•҉${prefix}greenneon text
│๖ۣ•҉${prefix}epeplogo text
│๖ۣ•҉${prefix}tulisanpasir text
│๖ۣ•҉${prefix}nulis text
│๖ۣ•҉${prefix}advanceglow text
│๖ۣ•҉${prefix}futureneon text
│๖ۣ•҉${prefix}sandwriting text
│๖ۣ•҉${prefix}sandsummer text
│๖ۣ•҉${prefix}sandengraved text
│๖ۣ•҉${prefix}metaldark text
│๖ۣ•҉${prefix}neonlight text
│๖ۣ•҉${prefix}holographic text
│๖ۣ•҉${prefix}text1917 text
│๖ۣ•҉${prefix}minion text
│๖ۣ•҉${prefix}deluxesilver text
│๖ۣ•҉${prefix}newyearcard text
│๖ۣ•҉${prefix}bloodfrosted text
│๖ۣ•҉${prefix}halloween text
│๖ۣ•҉${prefix}jokerlogo text
│๖ۣ•҉${prefix}fireworksparkle text
│๖ۣ•҉${prefix}natureleaves text
│๖ۣ•҉${prefix}bokeh text
│๖ۣ•҉${prefix}toxic text
│๖ۣ•҉${prefix}strawberry text
│๖ۣ•҉${prefix}box3d text
│๖ۣ•҉${prefix}roadwarning text
│๖ۣ•҉${prefix}breakwall text
│๖ۣ•҉${prefix}icecold text
│๖ۣ•҉${prefix}luxury text
│๖ۣ•҉${prefix}cloud text
│๖ۣ•҉${prefix}summersand text
│๖ۣ•҉${prefix}horrorblood text
│๖ۣ•҉${prefix}thunder text
│๖ۣ•҉${prefix}pornhub text1 text2
│๖ۣ•҉${prefix}glitch text1 text2
│๖ۣ•҉${prefix}avenger text1 text2
│๖ۣ•҉${prefix}space text1 text2
│๖ۣ•҉${prefix}ninjalogo text1 text2
│๖ۣ•҉${prefix}marvelstudio text1 text2
│๖ۣ•҉${prefix}lionlogo text1 text2
│๖ۣ•҉${prefix}wolflogo text1 text2
│๖ۣ•҉${prefix}steel3d text1 text2
│๖ۣ•҉${prefix}wallgravity text1 text2
╰────────────────⊱

╭──❲ 𝐏𝐇𝐎𝐓𝐎𝐓 𝐎𝐗𝐘 ❳
│๖ۣ•҉${prefix}shadow text
│๖ۣ•҉${prefix}cup text
│๖ۣ•҉${prefix}cup1 text
│๖ۣ•҉${prefix}romance text
│๖ۣ•҉${prefix}smoke text
│๖ۣ•҉${prefix}burnpaper text
│๖ۣ•҉${prefix}lovemessage text
│๖ۣ•҉${prefix}undergrass text
│๖ۣ•҉${prefix}love text
│๖ۣ•҉${prefix}coffe text
│๖ۣ•҉${prefix}woodheart text
│๖ۣ•҉${prefix}woodenboard text
│๖ۣ•҉${prefix}summer3d text
│๖ۣ•҉${prefix}wolfmetal text
│๖ۣ•҉${prefix}nature3d text
│๖ۣ•҉${prefix}underwater text
│๖ۣ•҉${prefix}golderrose text
│๖ۣ•҉${prefix}summernature text
│๖ۣ•҉${prefix}letterleaves text
│๖ۣ•҉${prefix}glowingneon text
│๖ۣ•҉${prefix}fallleaves text
│๖ۣ•҉${prefix}flamming text
│๖ۣ•҉${prefix}harrypotter text
│๖ۣ•҉${prefix}carvedwood text
│๖ۣ•҉${prefix}tiktok text1 text2
│๖ۣ•҉${prefix}arcade8bit text1 text2
│๖ۣ•҉${prefix}battlefield4 text1 text2
│๖ۣ•҉${prefix}pubg text1 text2
╰────────────────⊱

╭──❲ 𝐄𝐏𝐇𝐎𝐓𝐎 𝟑𝟔𝟎 ❳
│๖ۣ•҉${prefix}wetglass text
│๖ۣ•҉${prefix}multicolor3d text
│๖ۣ•҉${prefix}watercolor text
│๖ۣ•҉${prefix}luxurygold text
│๖ۣ•҉${prefix}galaxywallpaper text
│๖ۣ•҉${prefix}lighttext text
│๖ۣ•҉${prefix}beautifulflower text
│๖ۣ•҉${prefix}puppycute text
│๖ۣ•҉${prefix}royaltext text
│๖ۣ•҉${prefix}heartshaped text
│๖ۣ•҉${prefix}birthdaycake text
│๖ۣ•҉${prefix}galaxystyle text
│๖ۣ•҉${prefix}hologram3d text
│๖ۣ•҉${prefix}greenneon text
│๖ۣ•҉${prefix}glossychrome text
│๖ۣ•҉${prefix}greenbush text
│๖ۣ•҉${prefix}metallogo text
│๖ۣ•҉${prefix}noeltext text
│๖ۣ•҉${prefix}glittergold text
│๖ۣ•҉${prefix}textcake text
│๖ۣ•҉${prefix}starsnight text
│๖ۣ•҉${prefix}wooden3d text
│๖ۣ•҉${prefix}textbyname text
│๖ۣ•҉${prefix}writegalacy text
│๖ۣ•҉${prefix}galaxybat text
│๖ۣ•҉${prefix}snow3d text
│๖ۣ•҉${prefix}birthdayday text
│๖ۣ•҉${prefix}goldplaybutton text
│๖ۣ•҉${prefix}silverplaybutton text
│๖ۣ•҉${prefix}freefire text
╰────────────────⊱
...
break
		...
		case 'lpr':
					...
					client.sendMessage('6283818744065@s.whatsapp.net', options, text, {quoted: mek})
					reply('Masalah telah di laporkan ke owner 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 Laporan palsu atau main² tidak akan ditanggapi.')
					break
					case 'antidelete':
		...
		case 'request':
					...
					client.sendMessage('6283818744065@s.whatsapp.net', options, text, {quoted: fharga})
					client.sendMessage('6283818744065@s.whatsapp.net', options, text, {quoted: fharga})
					client.sendMessage('6283818744065@s.whatsapp.net', options, text, {quoted: fharga})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER BOTZ DHANI REQUESTS PALSU ATAU MAIN² TIDAK AKAN DITANGGAPI.')
					break
		case 'blocklist': 
...
if (args.length == 0) return reply(`Idnya mana kak?`)
		...
		case 'sewabot':
		wibu = fs.readFileSync(`./mp3/wibu.mp3`)
		wew = fs.readFileSync(`./src/sewa.jpg`)
		                     zain = `
...
──────────────────────────────
➢ 𝑮𝒓𝒖𝒑 𝑩𝒐𝒕 : *https://chat.whatsapp.com/IQXxFT6L1Ih0kAjbg6m9lp*
──────────────────────────────
➢ 𝑪𝒓𝒆𝒂𝒕𝒐𝒓 𝑩𝒐𝒕𝒛 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍 : *https://chat.whatsapp.com/Imr2vi3rsKJ8tbskw53edf*
──────────────────────────────
➢ 𝒀𝒐𝒖𝒕𝒖𝒃𝒆 : *https://youtube.com/channel/UC9WgqpVGWW87R3RWjmAxZgg*
──────────────────────────────
➢ 𝐍𝐎𝐓𝐄 : 𝐁𝐎𝐓 𝐎𝐍 𝟐𝟒 𝐉𝐀𝐌 𝐊𝐀𝐑𝐄𝐍𝐀 𝐏𝐀𝐊𝐄𝐊 𝐑𝐃𝐏 ⚠️
──────────────────────────────
➢ 𝐉𝐈𝐊𝐀 𝐌𝐈𝐍𝐀𝐓 𝐒𝐈𝐋𝐀𝐊𝐀𝐍 𝐇𝐔𝐁𝐔𝐍𝐆𝐈 𝐎𝐖𝐍𝐄𝐑
     ??𝐄𝐍𝐆𝐀𝐍 𝐂𝐀𝐑𝐀 𝐊𝐄𝐓𝐈𝐊 #𝐨𝐰??𝐞𝐫
──────────────────────────────
🔰 -----[「 𝑺𝒆𝒘𝒂 𝑩𝒚 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 」]----- 🔰
`
client.sendMessage(from, wew, image, {quoted: fharga, caption: zain, pushname, prefix, getLevelingXp, getLevelingLevel, sender, role })
break
		...
		case 'bot':
					...
					duingz = fs.readFileSync('./assets/sayang.mp3')
					client.sendMessage(from, duingz, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true} )
					break
		case 'wa.me':
		case 'wame':
		...
		case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `*「 Ndyie 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 」*\n\n${body.slice(4)}`})
						}
		...
		case 'bcc': 
				if (!isAdmin) return reply('*Only Admin bot*')
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						buff = await client.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `*「 NDAABOTZ BROADCAST 」*\n\n${body.slice(4)}`})
						}
						reply('*Suksess broadcast* ')
					} else {
						for (let _ of anu) {
		...
		case 'group':
            ...
            case 'developer':
                  ...
                  duingz = fs.readFileSync('./assets/herman.mp3')
                  client.sendMessage(from, '𝐓𝐮𝐡 𝐍𝐨𝐦𝐨𝐫 𝐎𝐰𝐧𝐞𝐫 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 , 𝐄𝐦𝐚𝐧𝐠 𝐋𝐮𝐡 𝐌𝐚𝐮 𝐀𝐩𝐚 𝐂𝐡𝐚𝐭 𝐎𝐰𝐧𝐞𝐫 𝐆𝐮𝐚 ? ',MessageType.text, { quoted: mek} )
                  client.sendMessage(from, duingz, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true} )
					break    
           case 'setname':
					if (!isGroup) return reply(ind.groupo())
 ...
 @${mentioned[0].split('@')[0]} 🤭`, mentioned, true)
		...
		case 'clone':
				...
				case 'wait':
					...
					break
case 'bocil':
client.sendMessage(from, 'Maaf Kaa Fitur Ini Telah Di Matikan Oleh Owner Silahkan Coba Fitur Lain',MessageType.text, { quoted: mek} )
break
...
case 'm':
case 'memo':
client.sendMessage(from, 'Apaan cuk gue gak ngerti',MessageType.text, { quoted: mek} )
break
case 'sholawat':
case 'sholawatan':
client.sendMessage(from, 'Maaf Kaa Fitur Ini Telah Di Matikan Oleh Owner Silahkan Coba Fitur Lain',MessageType.text, { quoted: mek} )
...
//MAKERMENU
                ...
                case 'thunder':
		if (!isRegistered) return reply(ind.noregis())
                     if (args.length == 0) return reply(`Teks Mana Om? Contoh ${prefix + command} 𝐒𝐮𝐛𝐫𝐞𝐤 𝐘𝐭 : 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 ?`)
	                reply(ind.wait())
                    ini_txt = args.join(" ")
        ...
        if (!isRegistered) return reply(ind.noregis())
	                ...
	                client.sendMessage(from, buffer, image, { quoted: mek, caption:'𝐍𝐢𝐡 𝐊𝐚𝐤 𝐃𝐚𝐡 𝐉𝐚𝐝𝐢\n𝐉𝐀𝐍𝐆𝐀𝐍 𝐋𝐔𝐏𝐀 𝐒𝐔𝐁𝐑𝐄𝐊 𝐘𝐓 : 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 ?',  contextInfo: { forwardingScore: 1000, isForwarded: true}})
	                await limitAdd(sender)
	                break
        ...
        if (!isRegistered) return reply(ind.noregis())
         ...
         if (!isRegistered) return reply(ind.noregis())
                    ...
                    anu = (buffer.result)
                    client.sendMessage(from, anu, image, { quoted: mek, caption:'𝐍𝐢𝐡 𝐊𝐚𝐤 𝐃𝐚𝐡 𝐉𝐚𝐝𝐢\n𝐉𝐀𝐍𝐆𝐀𝐍 𝐋𝐔𝐏𝐀 𝐒𝐔𝐁𝐑𝐄𝐊 𝐘𝐓 : 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 ?', contextInfo: { forwardingScore: 1000, isForwarded: true}})
	                await limitAdd(sender)
	                break
		...
		if (!isRegistered) return reply(ind.noregis())
                    ...
                    client.sendMessage(from, ini_buffer, image, { quoted: fharga, caption:'𝐍𝐢𝐡 𝐊𝐚𝐤 𝐃𝐚𝐡 𝐉𝐚𝐝𝐢\n𝐉𝐀𝐍𝐆𝐀𝐍 𝐋𝐔𝐏𝐀 𝐒𝐔𝐁𝐑𝐄𝐊 𝐘𝐓 : 𝑵𝒅𝒚𝒊𝒆 𝑩𝒐𝒕𝒛 ?', contextInfo: { forwardingScore: 1000, isForwarded: true}})
                    break
...
//DOWNLOAD MENU
				...
				if (budy.includes(`Mmk`)) {
					reply(`Widih Luh Dah Jago Kah Bang ? 😱`)
                  }
			    if (budy.includes(`Kontol`)) {
					reply(`Anjirr Ada Jagoan Gak Tuh 😱`)
                  }
		...
		if (budy.includes(`Assalamualaikum`)) {
                  ...
                  reply(`Yoi Kak 😳 ${pushname}`)
                  }
                  
		if (budy.includes(`Thanks`)) {
                  reply(`Yoi Kak 😳 ${pushname}`)
                  }
		if (budy.includes(`6283818744065`)) {
                  reply(`Apasih Tag Owner Gua\nKalau Butuh Ketik #owner`)
                  duingz = fs.readFileSync('./assets/lagu2.mp3')
